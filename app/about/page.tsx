  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16">
      ...
      <ul className="mt-6 text-zinc-400 list-disc pl-5 space-y-2">
        ...
        <li>Trust: SHA256 proof packets and payout ledger.</li>
      </ul>
      <h2 id="discord" className="mt-8 text-xl font-semibold">Community</h2>
      <p className="mt-2 text-zinc-400">
        Join the Discord to get updates and early access: <span className="underline">discord.gg/v3g4V2GtzT</span>
      </p>
    </main>
  );
}
